        ...
        <form method="post" enctype='multipart/form-data' role="form">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>CPF</label>
                        <input type="text" class="form-control" name="cpf" id="cpf" onkeyup="mascara(this,mnum)"
                               placeholder="CPF" maxlength="11" value="<?php echo $dados['CPF']; ?>" required>
                    </div>
                </div>
            </div><!-- /.row -->
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        <label>Celular</label>
                        <input type="text" class="form-control" onkeyup="return mascara(this,mCel);" name="celular"
                               maxlength="15" placeholder="(DDD)numero" value="<?php echo $dados['CELULAR']; ?>"
                               required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="email" placeholder="E-mail"
                               maxlength="250" value="<?php echo $dados['EMAIL']; ?>" required>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="inscricao" placeholder="Inscrição"
                               value="<?php echo $dados['DATA_INSCR']; ?>" required>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function imagem(x) {
        ...
        if (img) img = "<?=$aluno->URL?>/public/upload/" + img;
        else
            img = "<?=$aluno->URL?>/public/upload/semfoto.png";
