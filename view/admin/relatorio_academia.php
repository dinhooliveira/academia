                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="dataI"  value="<?php if(isset($_POST["dataI"]))echo $_POST["dataI"];?>"required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="dataF" value="<?php if(isset($_POST["dataF"]))echo $_POST["dataF"];?>" required>
                            </div>
                        </div>
                    </div>  
